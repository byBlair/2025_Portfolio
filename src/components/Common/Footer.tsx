...
const Footer: React.FC = () => {
    return (
        <FooterWrap>
            ...
            <Container>
                <SocialContainer>
                    <SocialLink href="mailto:jkas8233@gmail.com" aria-label="이메일 주소: jkas8233@gmail.com">
                        jkas8233@gmail.com
                    </SocialLink>
                    <SocialLink
                        href="https://github.com/byBlair"
                        target="_blank"
                        rel="noopener noreferrer"
                        aria-label="깃허브 주소: https://github.com/byBlair"
                    >
                        https://github.com/byBlair
                    </SocialLink>
                </SocialContainer>
                ...
                <FooterBottom>
                    <p>©2025 JihyunKim. All Rights Reserved.</p>
                </FooterBottom>
            </Container>
        </FooterWrap>
    );
